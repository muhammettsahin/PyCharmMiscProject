...
time.sleep(5)
uretici.click()
uretici.send_keys("SPJ")
time.sleep(10)

target = driver.find_element(By.XPATH, "//div[normalize-space(text())='SPJ']")
target.click()
time.sleep(60)
...
df.to_excel("kraftvoll15102025121.xlsx", index=False)
